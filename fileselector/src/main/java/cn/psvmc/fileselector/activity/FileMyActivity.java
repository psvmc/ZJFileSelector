...
import cn.psvmc.fileselector.adapter.FileMyListAdapter;
import cn.psvmc.fileselector.bean.MyFile;
import cn.psvmc.fileselector.bean.SelectedFiles;
import cn.psvmc.fileselector.util.FileComparator;
...
public class FileMyActivity extends Activity implements OnClickListener, OnItemClickListener {
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.iv_file_my_back) {
            onBackPressed();
        } else if (view.getId() == R.id.iv_file_my_back) {
